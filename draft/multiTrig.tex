...
\newtheorem{ce}[thm]{Counter-example}
...
\title{Structure of multi-triangulations on any surface}

%% define your authors in the usual way
%% use \addressmark{1}, \addressmark{2} etc for the institutions, and use \thanks{} for contact details
\author{Mathias Lepoutre \thanks{\href{mailto:mathias.lepoutre@polytechnique.edu}{mathias.lepoutre@polytechnique.edu}
. Partially supported by the project ANR-16-CE40-0009.}
, Vincent Pilaud
\thanks{\href{mailto:vincent.pilaud@lix.polytechnique.fr}{vincent.pilaud@lix.polytechnique.fr}}}



%\keywords{combinatorics, triangulation, surface}
...
\begin{defn}[infinite polygon]
An \emph{infinite polygon} is a circle with an infinite but ordered set of points on it.
\end{defn}

From now on, the word polygon will be used equally for both finite and infinite polygons.

\begin{defn}[left/right neighbour, \nbd]
If $x$ and $y$ are two points of a polygon, such that the interval $[x,y]$ is empty, we say that $y$ is the \emph{right neighbour} of $x$, while $x$ is the \emph{left neighbour} of $y$.
...
\end{lem}
\begin{proof}
cf Pilaud Santos. to be adapted to the infinite case, but shouldn't need any additional hypothesis.
\end{proof}

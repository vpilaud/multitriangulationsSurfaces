...
\begin{figure}
	\capstart
	\includegraphics[page=2, scale=.5, clip, trim=2cm 3cm 0.5cm 1cm]{FNSk3p2}
	\caption{An example of a $3$-triangulation of a half cylinder where the flip of the red edge is non-sequential.}
